...
CREATE TABLE IF NOT EXISTS participants(share_id INTEGER REFERENCES share(id) ON DELETE CASCADE, device_id INTEGER REFERENCES device(id), PRIMARY KEY(share_id, device_id));
